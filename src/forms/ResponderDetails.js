    ...
    return (
        <div className="fmResponderBox">
            ...
            <div className="respInnerBox">
                ...
                <input type="number" onWheel={(e) => e.target.blur()} className="numberInput" placeholder="Mobile Number" value={props.responder[2]} onChange={(e) => props.responderDetailsHandleChange(e)} required></input>
            </div>
        </div>
    )
}
